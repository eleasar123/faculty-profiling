<template>
  <v-container class="pa-0 ma-0 mr-0 pt-2 d-flex" fluid>
    <v-container
      ...
      v-if="user == 'Admin' && edit == false && create == false"
    >
      <v-card>
        <v-card-title>
          PERSONAL DATA SHEET
          ...
          <v-text-field
            ...
            dense
          ></v-text-field>
           <v-btn class=" ml-5   pa-2"  @click="createItem" v-if="createButton == true">Create</v-btn>
            <v-btn class=" ml-5   pa-2"  @click="viewAdminPds" v-if="viewButton == true">View</v-btn>
        </v-card-title>
        <v-data-table
          :headers="headers"
          :items="pds"
        ...
        <v-tab-item
          ...
          <v-container fluid class="ma-0 pa-0" id="printMeC1">
            ...
            >
              ...
              <v-container fluid class="ml-auto mr-auto mt-0">
                <span class="spanPdsThree" style="font-weight: bold">
                  Revised 2017</span
                ><span class="headerPds">Personal Data Sheet</span></v-container
              >

              <span label="Search" single-line hide-details class="spanPdsOne">
              ...
              <span label="Search" single-line hide-details class="spanPdsOne">
                ...
                (PDS) BEFORE ACCOMPLISHING THE PDS FORM.</span
              ><br />
              <span class="spanPdsTwo"
                >Print legibly. Tick appropriate boxes ( ) and use separate
                sheet if necessary. Indicate N/A if not applicable. </span
              ><span class="spanPdsOne">DO NOT ABBREVIATE.</span
              ><span class="spanPdsThree"> 1. CS ID No. </span
              ><span class="spanPdsThree"
                >(Do not fill up. For CSC use only)</span
              >
            </v-container>
            <v-container
              style="
            ...
            >
              I. PERSONAL INFORMATION</v-container
            >
            <v-simple-table
              id="pdsA"
              class="pa-0 mb-0 text-center"
              style="border: solid 1px"
              v-for="row in pdsPersonalInfo"
              :key="row.id"
            >
              <colgroup>
                <col id="colsPersonalInfoOne" />
                <col id="colsPersonalInfoTwo" />
                <!-- <col width="80px" style="background-color:yellow !important;border:solid 2px yellow"/> -->
                <col id="colsPersonalInfoThree" />
                <col id="colsPersonalInfoFour" />
                <col id="colsPersonalInfoFive" />
                <col id="colsPersonalInfoSix" />
                <col id="colsPersonalInfoSeven" />
              </colgroup>
              ...
              <tr class="tableRow">
                ...
                <td
                  ...
                  "
                >
                  <span class="suffix">NAME EXTENSION (JR., SR) </span>
              ...
              <tr style="height: 20px; font-size: 10px" class="tableRow">
                <td
                  class="tableHeader"
                  colspan="1"
                  style="
              ...
              <tr style="height: 20px; font-size: 10px" class="tableRow">
                ...
                <td rowspan="2" colspan="2" class="tableData">
                  {{ row.civil_status }}
                </td>
                <td
                  class="tableHeader"
                ...
                <td
                  ...
                  class="pa-0 tableData"
                >
                  <br v-if="row.residential_address_house_no == null" />
                  {{ row.residential_address_house_no }}
                  <v-divider></v-divider>
                  <span class="text-center locationLabel"
                    >House/Block/Lot No.
                  </span>
                </td>
                <td
                  ...
                  class="tableData"
                >
                  <br v-if="row.residential_address_street == null" />
                  {{ row.residential_address_street }}
                  <v-divider></v-divider>
                  <span class="text-center locationLabel">Street </span>
                </td>
              </tr>
              <tr class="tableRow">
                <td
                  ...
                  class="tableData"
                >
                  <br v-if="row.residential_address_subdivision == null" />
                  {{ row.residential_address_subdivision }}
                  <v-divider></v-divider>
                  <span class="text-center locationLabel"
                    >Subdivision/Village</span
                  >
                </td>
                <td
                  rowspan="1"
                ...
                >
                  ...
                  <v-divider></v-divider>
                  <span class="text-center locationLabel">Barangay</span>
                </td>
              </tr>
              ...
              <tr class="tableRow">
                ...
                <td colspan="2" style="border-right: none" class="tableData">
                ...
                <td colspan="2" style="border-left: none" class="tableData">
                  {{ row.residential_address_province }}
                  <v-divider></v-divider>

                  <span class="text-center locationLabel">Province</span>
                </td>
              </tr>
              <tr class="tableRow">
                <td
              ...
              <tr class="tableRow">
                ...
                <td
                  ...
                  "
                >
                  PERMANENT ADDRESS<br /><br /><br /><br /><br /><br /><br />
                  ZIP CODE
                </td>
                <td
                  rowspan="1"
                  ...
                  class="tableData"
                >
                  <br v-if="row.permanent_address_house_no == null" />
                ...
                <td
                  ...
                  class="tableData"
                >
                  <br v-if="row.permanent_address_street == null" />
              ...
              <tr class="tableRow">
                ...
                <td colspan="2" style="border-right: none" class="tableData">
                  <br v-if="row.permanent_address_subdivision == null" />
            ...
            >
              <colgroup>
                <col id="colsFamilyOne" />
                <col id="colsFamilyTwo" />
                <col id="colsFamilyThree" />
                <col id="colsFamilyFour" />
                <col id="colsFamilyFive" />
                <col id="colsFamilySix" />
                <col id="colsFamilySeven" />
                <col id="colsFamilyEight" />
              </colgroup>
              ...
              <tr class="tableRow">
                ...
                <td colspan="3" style="" class="tableData">
              ...
              <tr class="tableRow">
                ...
                <td colspan="1" class="tableData"></td>
              </tr>
              <tr class="tableRow">
                <td
                  class="tableHeader"
              ...
              <tr class="tableRow">
                ...
                <td colspan="3" class="tableData"></td>
                <td colspan="1" class="tableData">
            ...
            <v-simple-table>
              <colgroup>
                <col width="80px" id="colsEducOne" />
                <col width="100px" id="colsEducTwo" />
                <col width="100px" id="colsEducThree" />
                <col width="50px" id="colsEducFour" />
                <col width="50px" id="colsEducFive" />
                <col width="50px" id="colsEducSix" />
                <col width="50px" id="colsEducSeven" />
                <col width="50px" id="colsEducEight" />
              </colgroup>
              ...
              <tfoot>
                <tr style="" class="pdsDivider">
                  <td colspan="8" class="tableData"></td>
                </tr>
                <tr class="tableRow">
                  <td
                    class="tableHeader"
                  ...
                  <td
                    colspan="2"
                    class="imageContainer d-initial justify-content-center text-center"
                    style=""
                  >
                    <img
                      class="image"
          ...
          <v-container id="printMeC2">
            ...
            <v-simple-table height="auto" class="pa-0 pa-0 ma-0">
              <colgroup>
                <col id="colsCivilOne" />
                <col id="colsCivilTwo" />
                <col id="colsCivilThree" />
                <col id="colsCivilFour" />
                <col id="colsCivilFive" />
                <col id="colsCivilSix" />
                <col id="colsCivilSeven" />
                <col id="colsCivilEight" />
              </colgroup>
            ...
            <v-simple-table>
              ...
              <colgroup>
                <col id="colsWorkOne" />
                <col id="colsWorkTwo" />
                <col id="colsWorkThree" />
                <col id="colsWorkFour" />
                <col id="colsWorkFive" />
                <col id="colsWorkSix" />
                <col id="colsWorkSeven" />
                <col id="colsWorkEight" />
              </colgroup>
              ...
              <tfoot>
                ...
                <tr class="tableRow">
                  ...
                  <td
                    colspan="2"
                    class="d-initial justify-content-center text-center imageContainer"
                  >
                    <img
        ...
        <v-tab-item>
          <v-container id="printMeC3">
            ...
            <v-simple-table height="auto" class="pa-0 pa-0 ma-0">
              ...
              <tr
                class="pa-0 pdsDivider"
                style="border: solid 1px; background-color: rgb(234, 234, 234)"
              >
                <td colspan="8" style="height: 25px" class="tableData"></td>
              </tr>
            </v-simple-table>
            <v-container
              class="pa-0 text-left header headerWork"
            ...
            >
              ...
              PROGRAMS ATTENDED<br /><span class="spanLearning"
                ...
                for Division Chief/Executive/Managerial positions)</span
              >
            </v-container>
            <v-simple-table style="border: solid 1px solid">
              <colgroup>
                <col id="colsLearningOne" />
                <col id="colsLearningTwo" />
                <col id="colsLearningThree" />
                <col id="colsLearningFour" />
                <col id="colsLearningFive" />
                <col id="colsLearningSix" />
                <col id="colsLearningSeven" />
                <col id="colsLearningEight" />
              </colgroup>
              ...
              <tr
                v-for="row in pdsLearningAndDevelopment"
                :key="row.id"
                class="tableRow"
              >
                <td colspan="2" class="tableData">
            ...
            <v-simple-table>
              <colgroup>
                <col id="colsOtherOne" />
                <col id="colsOtherTwo" />
                <col id="colsOtherThree" />
                <col id="colsOtherFour" />
                <col id="colsOtherFive" />
                <col id="colsOtherSix" />
                <col id="colsOtherSeven" />
                <col id="colsOtherEight" />
              </colgroup>
              ...
              <tr v-for="row in pdsOtherInfo" :key="row.id" class="tableRow">
                <td colspan="2" class="tableData">
        ...
        <v-tab-item>
          <v-container id="printMeC4">
            <v-container
              ...
              :key="row.id"
            >
              <v-row no-gutters class="ma-0 pa-0" cols="12">
                <v-col cols="8" sm="8" class="ma-0 mr-0 pdsContainerQ34">
                  <v-card
                    class="pa-0 ma-0 questionText"
                    tile
                    style="
                      text-align: left;
                      border: solid 1px black;
                  ...
                  >
                    ...
                    where you will be apppointed,<br />
                    a. within the third degree? <br />b. within the fourth
                    degree (for Local Government Unit - Career Employees)?<br /><br /><br
                  /></v-card>
                </v-col>
                <v-col
                  cols="4"
                  sm="4"
                  class="text-left pdsContainerA34"
                  style="border: solid 1px black"
                >
                  <v-card class="pl-3 answerText" height="118px">
                    <span class="questionText">If YES, give details:</span
                    ><br />
              ...
              <v-row no-gutters>
                <v-col cols="8" sm="8" class="ma-0 mr-0 pdsContainerQ35">
                  <v-card
                    height="70px"
                    class="pa-0 questionText"
                    outlined
                    tile
                    style="
                      text-align: left;
                ...
                <v-col
                  ...
                  sm="4"
                  md="4"
                  class="text-left pdsContainerA35"
                  style="border: solid 1px black"
                >
                  <v-card height="68px" class="pl-2 answerText" tile>
                    <u>{{ row.question_thirty_five_a }}</u>
                    <span class="pl-3 questionText">If YES, give details: </span
                    ><br />
                    <label class="pl-3 questionText">Date Filed:</label>
                    <u>{{ row.question_thirty_five_b_date_filed }}</u
                    ><br />
                    <label class="pl-3 questionText">Status of Case/s:</label>
                    <u>{{ row.question_thirty_five_B_status_of_case }}</u>
                  </v-card>
                </v-col>
              </v-row>
              <v-row no-gutters>
                <v-col
                  ...
                  sm="8"
                  md="8"
                  class="ma-0 pb-2 mr-0 pdsContainerQ36"
                  style="border: solid 1px black"
                >
                  <v-card
                    class="pa-0 questionText"
                  ...
                  >
                    ...
                    of any law, decree, ordinance or regulation by any court or
                    tribunal?</v-card
                  >
                </v-col>
                <v-col
                  ...
                  sm="4"
                  md="4"
                  class="text-left pdsContainerA36"
                  height="65px"
                  style="border: solid 1px black"
                >
                  <v-card class="pl-3 answerText mb-0" height="65px" tile>
                    <span class="pl-3 questionText">If YES, give details: </span
                    ><br />
              ...
              <v-row no-gutters>
                <v-col cols="8" sm="8" md="8" class="ma-0 mr-0 pdsContainerQ37">
                  <v-card
                    class="pa-0 questionText"
                    outlined
                    tile
                ...
                <v-col
                  ...
                  sm="4"
                  md="4"
                  class="text-left pdsContainerA37"
                  style="border: solid 1px black"
                >
                  <v-card class="pl-3 answerText" height="60px">
                    <span class="ma-3 questionText">If YES, give details: </span
                    ><br />
                    <u>{{ row.question_thirty_seven }}</u>
                  </v-card>
                </v-col>
              </v-row>
              <v-row no-gutters>
                <v-col cols="8" sm="8" md="8" class="ma-0 mr-0 pdsContainerQ38">
                  <v-card
                    class="pa-0 questionText"
                    outlined
                    tile
                ...
                <v-col
                  ...
                  sm="4"
                  md="4"
                  class="text-left pdsContainerA38"
                  style="border: solid 1px black"
                >
                  <v-card class="pa-3 answerText" height="80px">
                    <span class="pl-3 questionText">If YES, give details: </span
                    ><br />
                    <u>{{ row.question_thirty_eight_a }}</u>
                    <span class="pl-3 questionText">If YES, give details: </span
                    ><br />
                    <u>{{ row.question_thirty_eight_a }}</u>
                  </v-card>
              ...
              <v-row no-gutters>
                <v-col cols="8" sm="8" md="8" class="ma-0 mr-0 pdsContainerQ39">
                  <v-card
                    class="pa-0 questionText"
                    outlined
                    tile
                  ...
                  >
                    ...
                    permanent resident of another country?</v-card
                  >
                </v-col>
                <v-col
                  cols="4"
                  sm="4"
                  md="4"
                  class="text-left pdsContainerA39"
                  style="border: solid 1px black"
                >
                  <v-card class="pl-3 answerText" height="60px">
                    <span class="pl-3 questionText">If YES, give details: </span
              ...
              <v-row no-gutters>
                <v-col cols="8" sm="8" md="8" class="ma-0 mr-0 pdsContainerQ40">
                  <v-card
                    class="pa-0 questionText"
                    outlined
                    tile
                  ...
                  >
                    ...
                    (RA 8371); (b) Magna Carta for Disabled Persons (RA 7277);
                    and (c) Solo Parents Welfare Act of 2000 (RA 8972), please
                    answer the following items: Screen reader support enabled.
                    <br />a. Are you a member of any indigenous group?<br />
                    b. Are you a person with disability? <br />c. Are you a solo
                    parent?</v-card
                  >
                </v-col>
                <v-col
                  ...
                  sm="4"
                  md="4"
                  class="text-left pdsContainerA40"
                  style="border: solid 1px black"
                >
                  <v-card class="pl-3 answerText" height="95px" tile>
                    <span class="pl-3 questionText"
                      >If YES, please specify:
                    </span>
                    <u> {{ row.question_forty_a }} </u><br />
                    <span class="pl-3 questionText"
                      >If YES, please specify ID No:
                    </span>

                    <u> {{ row.question_forty_b }} </u><br />
                    <span class="pl-3 questionText"
                      >If YES, please specify ID No: </span
                    ><br />
                ...
                <v-col cols="8" sm="8">
                  <v-card class="pa-0" outlined tile height="auto">
                    ...
                    <v-card
                      ...
                      "
                    >
                      42. I declare under oath that I have personally
                      accomplished this Personal Data Sheet which is a true,
                      correct and complete statement pursuant to the provisions
                      of pertinent laws, rules and regulations of the Republic
              ...
              <v-row class="pa-0">
                ...
                <v-col cols="4" sm="4">
                  <v-card style="border: solid 1px black">
                    <v-container
                      style="height: 90px; border: solid 1px black"
                    ...
                    <span
                      ...
                      >Signature (Sign inside the box)</span
                    >
                ...
                <v-col cols="4" sm="4">
                  <v-card style="border: solid 1px black">
                    <v-container
                      style="height: 130px; border: solid 1px black"
          ...
          > -->
            ...
            style="height: 30%; width: 30%"
          /> -->
                    <b>{{ addInfo.person_administering_oath }} </b>
            ...
            <tbody class="text-center" color="primary">
              <tr>
                <td
                  ...
                  "
                >
                  2. SURNAME<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="7">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  FIRST NAME<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="4">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  MIDDLE NAME<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="7">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                ...
                >
                  DATE OF BIRTH <br />
                  (mm/dd/yyyy)<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-row>
                ...
                <td colspan="3" class="text-left">
                   <label>Citizenship<span class="red--text text--lighten-1 ">*</span></label>
                  <v-text-field
                    placeholder=""
                    solo
                    :rules="required"
              ...
              <tr>
                <td
                  ...
                  "
                >
                  PLACE OF BIRTH<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2"> 
                  <v-text-field
                    placeholder=""
                ...
                <td colspan="3" class="text-left">
                    <label>Country of Citizenship<span class="red--text text--lighten-1">*</span></label>
                  <v-text-field
              ...
              <tr>
                <td
                  ...
                  "
                >
                  SEX<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  rowspan="2"
                >
                  CIVIL STATUS<span class="red--text text--lighten-1">*</span>
                </td>
                ...
                >
                  ...
                  ZIP CODE<span class="red--text text--lighten-1">*</span>
                </td>
              ...
              <tr>
                ...
                <td rowspan="1" colspan="2" style="border-left: none">
                  ...
                  <label>Barangay<span class="red--text text--lighten-1">*</span></label>
                </td>
              </tr>
              ...
              <tr>
                <td
                  ...
                  "
                >
                  HEIGHT (m)<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
                ...
                <td colspan="2" style="border-right: none">
                  ...
                  >
                   ...
                   <label>City/Municipality<span class="red--text text--lighten-1">*</span></label>
                </td>
                <td colspan="2" style="border-left: none">
                  ...
                  >
                    ...
                    <label>Province<span class="red--text text--lighten-1">*</span></label>
                </td>
              </tr>
              <tr>
                <td
                  ...
                  "
                >
                  WEIGHT (kg)<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  BLOOD TYPE<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  GSIS ID NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  PAG-IBIG ID NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  PHILHEALTH NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  SSS NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
                ...
                <td
                  ...
                  "
                >
                  19.TELEPHONE NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="4">
                  <v-text-field
              ...
              <tr>
                <td
                  ...
                  "
                >
                  14.TIN NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
                ...
                <td
                  ...
                  "
                >
                  20.MOBILE NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="4">
                  <v-text-field
              ...
              <tr>
                <td
                  ...
                  "
                >
                  AGENCY EMPLOYEE NO.<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="2">
                  <v-text-field
                    placeholder=""
                ...
                <td
                  ...
                  "
                >
                  21. E-MAIL ADDRESS (if any)<span class="red--text text--lighten-1">*</span>
                </td>
              ...
              <tr>
                <td
                  ...
                  "
                >
                  25. FATHER'S SURNAME<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="3">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  26. MOTHER'S MAIDEN NAME<span class="red--text text--lighten-1">*</span>
                </td>
                <td colspan="3">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  SURNAME <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td colspan="3">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  FIRST NAME <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td colspan="3">
                  <v-text-field
                    placeholder=""
              ...
              <tr>
                <td
                  ...
                  "
                >
                  MIDDLE NAME <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td colspan="3">
                  <v-text-field
                    placeholder=""
              ...
              <tr
                ...
                style="border: solid 1px; background-color: rgb(150, 150, 150)"
              >
                <td
                  colspan="8"
                  class="text-left"
              ...
              <tr>
                ...
                <td
                  ...
                  "
                >
                  NAME OF SCHOOL<br />(Write in full) <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td
                  rowspan="2"
                  style="
              ...
              <tr>
                <td
                  ...
                  "
                >
                  From <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td
                  style="
                    text-align: left;
                  ...
                  "
                >
                  To <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
              </tr>
              ...
              <tr>
                <td
                  ...
                  "
                >
                  SIGNATURE <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td colspan="2">
                  <v-file-input
                    dense
                ...
                <td
                  ...
                  "
                >
                  DATE <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td colspan="3">
                  <v-row>
                    <v-col cols="12" sm="8" md="8" class="text-center">
          ...
          <v-simple-table height="auto" class="pa-0 pa-0 ma-0">
            <thead>
              ...
              <tr style="border: solid 1px black">
                ...
                >
                  CAREER SERVICE/ RA 1080 (BOARD/ BAR) UNDER SPECIAL LAWS/ CES/
                  CSEE BARANGAY ELIGIBILITY / DRIVER'S LICENSE <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
                  ...
                  "
                >
                  RATING <br />(If Applicable) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
                  ...
                  "
                >
                  DATE OF EXAMINATION / CONFERMENT <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="2"
                  ...
                  "
                >
                  PLACE OF EXAMINATION / CONFERMENT <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  colspan="2"
                  style="
                  ...
                  "
                >
                  LICENSE (if applicable) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
              ...
              <tr>
                <th
                  ...
                  "
                >
                  NUMBER <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  style="
                    text-align: left;
                  ...
                  "
                >
                  Date of Validity <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                <th
                  ...
                  "
                >
                  28. INCLUSIVE DATES (mm/dd/yyyy) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
                  ...
                  "
                >
                  POSITION TITLE (Write in full/Do not abbreviate) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
                ...
                >
                  DEPARTMENT / AGENCY / OFFICE / COMPANY (Write in full/Do not
                  abbreviate) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
                  ...
                  "
                >
                  MONTHLY SALARY <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  colspan="1"
                  rowspan="2"
                ...
                >
                  SALARY/ JOB/ PAY GRADE (if applicable)& STEP (Format "00-0")/
                  INCREMENT <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  colspan="1"
                  rowspan="2"
                  ...
                  "
                >
                  STATUS OF APPOINTMENT <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  colspan="1"
                  rowspan="2"
                  ...
                  "
                >
                  GOV'T SERVICE (Y/ N) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
          ...
          <v-simple-table height="auto" class="pa-0 pa-0 ma-0">
            <thead>
              ...
              <tr>
                <th
                  ...
                  "
                >
                  29. NAME & ADDRESS OF ORGANIZATION (Write in full) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  colspan="2"
                  style="
                  ...
                  "
                >
                  INCLUSIVE DATES (mm/dd/yyyy) <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
                  ...
                  "
                >
                  NUMBER OF HOURS <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="4"
                  ...
                  "
                >
                  POSITION / NATURE OF WORK <label><span class="red--text text--lighten-1 ">*</span></label>
                </th>
                <th
                  rowspan="2"
                  colspan="1"
            ...
            <tbody>
              ...
              <tr>
                ...
                >
                  30. TITLE OF LEARNING AND DEVELOPMENT INTERVENTIONS/TRAINING
                  PROGRAMS (Write in full) <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td
                  colspan="2"
                  style="
                  ...
                  "
                >
                  INCLUSIVE DATES OF ATTENDANCE (mm/dd/yyyy) <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td
                  rowspan="2"
                  colspan="1"
                ...
                <td
                  ...
                  "
                >
                  Type of LD ( Managerial/ Supervisory/ Technical/etc) <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
                <td
                  rowspan="2"
                  colspan="2"
                  ...
                  "
                >
                  CONDUCTED/ SPONSORED BY (Write in full) <label><span class="red--text text--lighten-1 ">*</span></label>
                </td>
        ...
        >
          <v-form ref="pds">
            <v-row no-gutters>
              ...
              <v-col cols="12" sm="6">
                <v-card class="pa-3" outlined tile height="165px">
                  <v-textarea
                    auto-grow
                    rows="4"
                    placeholder=""
            ...
            <v-row no-gutters class="ma-0">
              <v-col cols="12" sm="8">
                <v-card class="pa-0" outlined tile height="auto">
                  ...
                  <v-simple-table>
                    <thead>
                      <tr>
                        <th
                          ...
                          "
                        >
                          NAME <label><span class="red--text text--lighten-1 ">*</span></label>
                        </th>
                        <th
                          style="
                            text-align: left;
                          ...
                          "
                        >
                          ADDRESS <label><span class="red--text text--lighten-1 ">*</span></label>
                        </th>
                        <th
                          style="
                            text-align: left;
                          ...
                          "
                        >
                          TEL. NO. <label><span class="red--text text--lighten-1 ">*</span></label>
                        </th>
                    ...
                    <tbody>
                      <tr height="10px" v-for="row in references" :key="row.id">
                        <td>
                          <v-text-field
                            dense
                            v-model="row.name"
              ...
              <v-col cols="12" sm="4">
                <v-container class="pa-3 text-center" height="300px">
                  ...
                  <span class="text-center ma-0">PHOTO <label><span class="red--text text--lighten-1 ">*</span></label></span>
                </v-container>
              </v-col>
            </v-row>
              ...
              <v-col cols="12" sm="4" style="font-size: 10px">
                <v-card class="pa-0" style="border: solid 1px black">
                  ...
                  <v-container
                    ...
                    "
                  >
                  <label class="float-left">Government Issued ID:<span class="red--text text--lighten-1 ">*</span></label>
                    <v-text-field
                      dense
                      solo
                      label=""
                  ...
                  <v-container
                    ...
                    "
                  >
                   <label class="float-left">ID/License/Passport No.:<span class="red--text text--lighten-1 ">*</span></label>
                    <v-text-field
                      dense
                      solo
                      class="ma-0"
                  ...
                  <v-container
                    ...
                    "
                  >
                  <label class="float-left">Date/Place of Issuance:<span class="red--text text--lighten-1 ">*</span></label>
                    <v-text-field
                      dense
                      solo
                      class="ma-0"
              ...
              <v-col cols="12" sm="4">
                <v-card style="border: solid 1px black">
                  ...
                  <v-card-subtitle
                    class="text-center"
                    style="font-size: 10px;border: solid 1px black; border-right: solid 1px black;black;background-color:rgb(234, 234, 234);"
                    >Signature (Sign inside the box)<span class="red--text text--lighten-1 ">*</span></v-card-subtitle
                  >
                  <v-container style="border: solid 1px black">
                    <v-row>
                      <v-col cols="12" sm="12" md="12" class="text-center">
                  ...
                  <v-card-subtitle
                    class="text-center"
                    style="font-size: 10px;border: solid 1px black; border-right: solid 1px black;black;background-color:rgb(234, 234, 234);"
                    >Date Accomplished<span class="red--text text--lighten-1 ">*</span></v-card-subtitle
                  >
                </v-card>
              </v-col>
              <v-col cols="12" sm="4">
                <v-card style="border: solid 1px black">
                  ...
                  <v-card-subtitle
                    class="text-center"
                    style="font-size: 10px;border: solid 1px black; border-right: solid 1px black;black;background-color:rgb(234, 234, 234);"
                    >Right Thumbmark<span class="red--text text--lighten-1 ">*</span></v-card-subtitle
                  >
                </v-card>
              </v-col>
            </v-row>
            ...
            >
              <v-col cols="12" sm="4" style="border: none" class="text-right">
                SUBSCRIBED AND SWORN to before me this ,<span class="red--text text--lighten-1 ">*</span>
              </v-col>
            ...
            >
              ...
              <v-card-subtitle
                ...
                style="font-size: 10px;border: solid 1px black; border-right: solid 1px black;black;background-color:rgb(234, 234, 234);"
                >Person Administering Oath<span class="red--text text--lighten-1 ">*</span></v-card-subtitle
              >
            </v-card>
          </v-form>
        </v-container>
...
export default {
  data() {
    return {
      ...
      dateRules: [
        ...
        value => (Object.prototype.toString.call(new Date(value))
                                    === "[object Date]" )|| 'Invalid Date Format',
      ],
    };
  },
  ...
  created() {
    ...
    let fatherDOBLabel = document.getElementById('fatherDOB');
    console.log(fatherDOBLabel)
  },
  methods: {
    viewItem(item) {
      console.log(item);
      ...
      pdsOtherInfo = data[7][0].otherInfo[this.editedIndex];
      ...
      sessionStorage.setItem("pdsOtherInfo", JSON.stringify(pdsOtherInfo));
      // sessionStorage.setItem(
      //   "pdsOtherInfoNonacademicDistinctions",
    ...
    //button trigger method to create new pds for admin
    createItem(){
      this.create = true 
    },

    //view the pds of admin
    async viewAdminPds(){
    ...
    removeRow: function (array, row) {
      console.log(this.civilServiceEligibility);
      console.log(array, row);
      let index = 0;
      switch (array) {
        case "educationalBackground":
          index = this.educationalBackground.indexOf(row);
          console.log(index);
          this.educationalBackground.splice(index, 1);
          break;
        case "workExperience":
          index = this.workExperience.indexOf(row);
          this.workExperience.splice(index, 1);
          break;
        case "civilServiceEligibility":
          index = this.civilServiceEligibility.indexOf(row);
          this.civilServiceEligibility.splice(index, 1);
          break;
        case "voluntaryWorkInvolvement":
          index = this.voluntaryWorkInvolvement.indexOf(row);
          this.voluntaryWorkInvolvement.splice(index, 1);
          break;
        case "learningAndDevelopment":
          index = this.learningAndDevelopment.indexOf(row);
          this.learningAndDevelopment.splice(index, 1);
          break;
        case "otherInfo":
          index = this.otherInfo.indexOf(row);
    ...
    print() {
      ...
      var a = window.open("", "", "height=max-content, width=max-content");
