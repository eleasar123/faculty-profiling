    ...
    <v-tabs>
      ...
      <v-tab-item>
        ...
        <v-card>
          ...
          <!-- START OF KRA COLUMN table for admin-->
            ...
            <div class="ePart1">
              <template v-for="n in 22">
                ...
                >
                  ...
                  <v-card class="pa-1" style="height: 54px" v-model="dateObserved" outlined tile>
                ...
                >
                  ...
                  <div style="text-align: center; width: 60px">
                    ...
                    <v-card class="pa-1" style="height: 50px" outlined tile>
                      <v-text-field
                        v-model="encoding_ipcrfNumericalQ13"
                        placeholder=""
                        solo
                        dense
                        class="text-center"
                ...
                <div class="pa-10 ml-9" style="text-align: center">
                  <v-row>
                    <v-col>
                      ...
                      >
                       <v-text-field dense solo flat v-model="rateePart4"  readonly="user=='Admin'">
                    ...
                    <v-col>
                      ...
                      >
                       <v-text-field dense solo flat v-model="raterPart4"  readonly="user=='Admin'">
                    ...
                    <v-col>
                      <v-card class="pa-2" style="width: 250px; height: 100px">
                         <v-text-field dense solo flat v-model="approvingAuthorityPart4"  readonly="user=='Admin'">
